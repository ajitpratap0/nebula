...
require (
	...
	github.com/pixisai/go-nessie v1.102.1 // indirect
	...
	github.com/shubham-tomar/iceberg-go v0.2.1 // indirect
...
// replace github.com/shubham-tomar/iceberg-go => ../iceberg-go
